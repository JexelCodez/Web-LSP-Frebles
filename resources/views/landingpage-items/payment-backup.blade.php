            ...
            <div class="col-12">
                ...
                <div id="snap-container" class="card p-3">
                    <button id="pay-button" class="btn btn-primary p-2 w-100 h-100 d-flex align-items-center justify-content-between">
                        <span class="fw-bold">Via E-Wallet (Qris, GoPay, dll)</span>
                        <span>Bila pembayaran tidak muncul, mohon tunggu beberapa saat kemudian klik kembali. Dan jangan lupa untuk mengecek koneksi internet Anda.</span>
                    </button>
                </div>
            </div>
