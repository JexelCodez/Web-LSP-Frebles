...
<section class="vh-0 gradient-custom-2">
        ...
        <div class="card card-stepper" style="border-radius: 16px;">
          <div class="card-header p-4">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div>
                <h6 class="mb-0"> <a href="{{ route('dashboard') }}">Back</a> </h6>
              </div>
            </div>
          </div>
          <div class="card-body p-4">
            <div class="d-flex flex-row mb-4 pb-2">
              <div class="flex-fill">
                ...
                <h6 class="bold">{{ $order->category_name }}</h6>
                <p class="text-muted"> Qt: {{ $order->quantity }}</p>
                <h4 class="mb-3">Rp{{ number_format($order->price, 0) }} <span class="small text-muted"> via (COD) </span></h4>
                <p class="text-muted">Tracking Status on: <span class="text-body">11:30pm, Today</span></p>
              </div>
              <div>
                  <img src="{{ asset('storage/' . $order->image1_url) }}" alt="product_image" width="250">
              </div>
            </div>
