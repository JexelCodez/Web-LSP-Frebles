        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.users.update', $users->id) }}" method="POST" id="frmUsrEdit">
                        @csrf
                        @method('PUT')
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="name">Usertype</label>
                                    <input type="text" class="form-control" id="usertype" placeholder="The available levels right now are: Admin, User, and Owner (type in lowercase)" name="usertype" value="{{ $users->usertype }}">
                                </div>
