...
@section('main')
    ...
    <div class="container-fluid py-4">
        <a href="{{ route('admin.customers.create') }}" class="btn btn-info mb-2">Add Customer</a>
                                    ...
                                    @foreach ($customers as $index => $customer)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form action="{{ route('admin.customers.destroy', $customer->id) }}" method="POST" style="display: inline;" id="frmDeleteCustomer{{ $customer->id }}">
                                                    @csrf
                                                    @method('DELETE')
